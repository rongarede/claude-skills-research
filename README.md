...
A collection of 20 Claude Code skills for academic research, paper writing, and literature management.
...
| `docx-diff` | Compare formatting differences between two DOCX files |
...
| `rename-pdf` | Auto-rename PDFs using extracted metadata titles |
...
```bash
cd ~/.claude/skills-repos/research && bash uninstall.sh
```
